...
# 191 is last rev with tex/
# 217 is final revision (switched to trunk/tex/ layout)

rev=1
last_rev=114

repo=dnphotice12
output=ferguson-hotice12.pdf
...
while [ $rev -lt $((last_rev+1)) ]; do
    ...
    cd tex
    cat Makefile | sed s/ferguson-hotos11/ferguson-hotice12/ > m2
